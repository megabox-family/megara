  ...
  const commandArray = [
    {
      ...
      value: `\
        \nSet the function of a channel, needed for some Megara features.\
        \nExample: \`${commandSymbol}channelFunction log 822941461695299624\`\
      `,
    },
    {
      name: `\`${commandSymbol}channelList\``,
    ...
    },
    {
      ...
      value: `\
        ...
        \nThis is used to ensure color roles are places at the top for color priority, everything else will be sorted alphabetically.\
