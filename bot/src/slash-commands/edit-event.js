...
export const dmPermission = false,
  ...
  options = [
    ...
    {
      name: `screen`,
      description: `The screen number at which the event will take place for cinema events.`,
      type: ApplicationCommandOptionType.String,
    },
    {
      name: `seats`,
      description: `The range of seats you have reserved for this event for cinema events.`,
      type: ApplicationCommandOptionType.String,
    },
    {
      name: `hide-screen`,
