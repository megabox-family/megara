...
export default async function (interaction) {
  ...
  await queueApiCall({
    ...
    parameters:
      `${member} has requested a joinable channel named **${channelName}** be created, here's what else they had to say:` +
  ...
  await queueApiCall({
    apiCall: `editReply`,
    djsObject: interaction,
    parameters: `Your request to create a joinable channel named **${channelName}** has been submitted, you should hear back from an administrator shortly.`,
  })
}
